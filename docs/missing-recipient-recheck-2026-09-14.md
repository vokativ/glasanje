...
No new recipient was found. The durable set remains 100 candidate IDs, and the set of notice station/URL/email combinations is unchanged. The run refreshed observation times for known pages only. Mostar’s notice still exposes `gk.mostar@mfa.rs` for Mostar and does not establish a Drvar recipient. Tirana, Brasília, Vukovar, Tripoli, Herceg Novi, Bratislava, Tunis, Ankara and Istanbul still have current election notices with no recipient in their extracted body text.

The automated report remains partial because 14 selected records reached the bounded crawl depth and eight entries have no available mission site. Those are acquisition limits, not evidence that no later notice can exist. Public coverage remains **223 stations and 152 usable approved recipients**. No Firebase deployment was made because there was no new recipient, no new notice binding and no public approval change.
